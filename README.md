...
-- | ---------------- | ------------------------------------------------------------------------------------------------ | -- | --
1 | Diagrammanzeige | Als Benutzer möchte ich meinen Alkoholgehalt im Blut als Funktion der Zeit kennenlernen. <br><b> Akezeptanzkriterien: <br></b>- Testen Sie die Funktion der Taste " Graphic ".<br></b>- Test zur Darstellung einer Grafik, die den Blutalkoholspiegel als Funktion der Zeit anzeigt.| 1 | 1 |
