...
-- | ---------------- | ------------------------------------------------------------------------------------------------ | -- | --
1 | Diagramminitializierung | Als Benutzer möchte ich meinen Alkoholgehalt im Blut als Funktion der Zeit kennenlernen. <br><b> Akzeptanzkriterien: <br></b>- Test, ob die Funktion der Taste " Graphic " funktioniert.<br></b>- Test zur Darstellung einer Grafik, die den Blutalkoholspiegel als Funktion der Zeit anzeigt.| 8 | 1 |
